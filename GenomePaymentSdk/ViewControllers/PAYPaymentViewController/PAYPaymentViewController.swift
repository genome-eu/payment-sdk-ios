//
//  PAYPaymentViewController.swift
//  Genome_ios_temp
//
//  Created by Yevhen Triukhan on 20.10.2020.
//
...
Will send user date with payment request to Genome processing center.
 ...
 */
    ...
    private func configureUI() {
        ...
        rootView?.conditionsView.add(.termsAndPrivacy)
    ...
    private func bindFields() {
        guard
            ...
            let checkboxes = self.rootView?.conditionsView.checkboxViews
        else { return }

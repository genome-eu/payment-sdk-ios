...
//  Genome_iOS_dev
//
//  Created by Yevhen Triukhan on 22.10.2020.
//
...
final internal class PAYNetworkAPI {
    ...
    internal var mainURL: String { self.isProduction ? "https://gateway.genome.eu/api/cc" : "https://gateway-sandbox.genome.eu/api/cc" }
    ...
    /**
     Create dictionary representation of default HTTP header.
        ...
        - returns: Dictionary with default HTTP header fields requred by Genome processing center.
     */
